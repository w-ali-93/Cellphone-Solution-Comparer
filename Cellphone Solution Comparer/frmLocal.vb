...
Public Class frmLocal
    ...
    Private Sub frmLocal_Move(sender As Object, e As EventArgs) Handles Me.Move
    ...
    Private Sub frmLocal_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
        is_painted = True
    End Sub
